            ...
            case 'CONTATOS' ;
              ...
              require_once('./Controller/ControllerUsuarios.php');
                        ...
                        if($action == 'INSERIR'){
                         ...
                         $resposta =  inserirCategoria($_POST);                                // esta colocando o return do inserirContatos na variavel %resposta
                       ...
                       //assim não  havera um novo carregamento da pagina
                         require_once('index.php');
                          ...
                          $resposta =  atualizarCategoria($_POST , $idcontato);                                // esta colocando o return do inserirContatos na variavel %resposta
